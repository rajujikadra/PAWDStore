...
function Product_list_side_bar(data, AllProduct, Heading) {
    if (Heading != null) {
        if (Heading.Heading != null)
            ...
            $("#header").append("Rimp Trading Company");
        if (Heading.Description != null)
            $("#Description").append(Heading.Description);
        else
            $("#Description").append("We Provide CCTV Camera, Stand alone DVR, Video Door Phone, Access Control, Bio-metric Attendance System, Cables & Connectors for Security purpose");
