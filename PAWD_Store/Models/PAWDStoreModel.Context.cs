...
namespace PAWD_Store.Models
{
    ...
    public partial class PAWDStoreEntities : DbContext
    {
        public PAWDStoreEntities()
            : base("name=PAWDStoreEntities")
        {
        }
        ...
        public virtual DbSet<ContactUS_Master> ContactUS_Master { get; set; }
        ...
        public virtual DbSet<User_Address_Master> User_Address_Master { get; set; }
        public virtual DbSet<UserDetails_Master> UserDetails_Master { get; set; }
    
        [DbFunction("PAWDStoreEntities", "SplitString")]
        public virtual IQueryable<SplitString_Result> SplitString(string input, string character)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitString_Result>("[PAWDStoreEntities].[SplitString](@Input, @Character)", inputParameter, characterParameter);
        }
        ...
        public virtual ObjectResult<GetAllProductSubCategoryWise_Result> GetAllProductSubCategoryWise(Nullable<int> subCategoryID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllProductSubCategoryWise_Result>("GetAllProductSubCategoryWise", subCategoryIDParameter);
        }
    
        public virtual ObjectResult<GetAllProductThirdCategoryWise_Result> GetAllProductThirdCategoryWise(string thirdCategory_ID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllProductThirdCategoryWise_Result>("GetAllProductThirdCategoryWise", thirdCategory_IDParameter);
        }
        ...
        public virtual ObjectResult<GetHotProduct_Result> GetHotProduct()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetHotProduct_Result>("GetHotProduct");
        }
        ...
        public virtual ObjectResult<RGetSubCategory_Result> RGetSubCategory()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RGetSubCategory_Result>("RGetSubCategory");
        }
